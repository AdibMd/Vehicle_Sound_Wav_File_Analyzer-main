...
class ContactForm(models.Model):
    ...
    # file = models.FileField(upload_to='user_15/')
    class Meta:
        db_table = "vehicle_specification"


class SendForm(models.Model):
    spectrogram = models.CharField(max_length=100)
    file = models.FileField(upload_to='user_15/')

    class Meta:
        db_table = "file_viewer"
